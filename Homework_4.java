/**
 * Java. Level 1. Lesson 4. Homework_4
 * @author Plieva Maya
 * @version Sep 23, 2018
 */
...
class Homework_4 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            g.playerTurn();
            g.printMap();
            if (g.checkWin(g.player)) { System.out.println("Winner"); break; }
            if (g.isMapFull()) { System.out.println("Game over, nobody win"); break; }

            //cpu-1 turn
            g.aiTurn(g.cpu1);
            g.printMap();
            if (g.checkWin(g.cpu1)) { System.out.println("Game over"); break; }
            if (g.isMapFull()) { System.out.println("Game over, nobody win"); break; }
...
//            g.aiTurn(g.cpu2);
//            g.printMap();
//            if (g.checkWin(g.cpu2)) { System.out.println("Game over"); break; }
//            if (g.isMapFull()) { System.out.println("Game over, nobody win"); break; }
//
//
//            //CPU-3 turn
//            g.aiTurn(g.cpu3);
//            g.printMap();
//            if (g.checkWin(g.cpu3)) { System.out.println("Game over"); break; }
//            if (g.isMapFull()) { System.out.println("Game over, nobody win"); break; }
        }
    }
    ...
    void playerTurn() {
        int x, y;
        do {
            System.out.println("Ur choice. Enter coordinates >X vY");
            x = sc.nextInt() - 1;
            y = sc.nextInt() - 1;
    ...
    void aiTurn(char c) {
        ...
        System.out.println("Cpu choice [" + c +"]:");
