/**
 * Java. Level 1. Lesson 8. Homework_8
 * @author Plieva Maya
 * @version Oct 7, 2018
 */
...
public class TicTacToe extends JFrame {
    ...
    boolean isFull() {
        ...
        int reply = JOptionPane.showConfirmDialog(null, "Want to restart?", 
            "Full", JOptionPane.YES_NO_OPTION);
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            for (int j = 0; j < SIZE; j++) {
                if (buttons[i][j].getText().equals("X")) {
                    ...
                    if (countXH == SIZE) {
                        int reply = JOptionPane.showConfirmDialog(null, 
                            "You Win! Want to restart?", "Map is full", 
                ...
                if (buttons[i][j].getText().equals("O")) {
                    ...
                    if (countOH == SIZE) {
                        int reply = JOptionPane.showConfirmDialog(null, 
                            "Loose! Want to restart?", "Map is full", 
                            JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
                ...
                if (buttons[j][i].getText().equals("X")) {
                    ...
                    if (countXV == SIZE) {
                        int reply = JOptionPane.showConfirmDialog(null, 
                            "Win! Want to restart?", "Map is full", 
                            JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
